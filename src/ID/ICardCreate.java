 ...
 * @author Jacob Mahto
 */
public class ICardCreate extends javax.swing.JFrame implements Printable{
public static String[] sname,fname,fcon,dob,address,roll,exaSession,sr;
...
double y=60,x=60,xScale=.45,yScale=.56;
    ...
    public void setFormat(String student,String father,String contact,String dob,String add,String sr){
    ...
    if(stdCB.getSelectedIndex()<=13 && stdCB.getSelectedIndex()>3){stdTF.setText(stdCB.getSelectedItem()+" ( "+stdToText((String)stdCB.getSelectedItem())+" )");}
        else {stdTF.setText((String)stdCB.getSelectedItem());}
...
RenderingHints.VALUE_ANTIALIAS_ON);
        ...
        int inCol=4;
        //g.translate(36,36);
        for(int i=pageIndex*9;i<sname.length && i<((pageIndex+1)*9);i++){
        if(i%9==0){
        g.translate(x, y);
        }
        else if(i%9==3){
        ...
        setFormat(sname[i], fname[i], fcon[i],dob[i], address[i],sr[i]); 
        contP.print(g);
...
RenderingHints.VALUE_ANTIALIAS_ON);
    ...
    private void initComponents() {
        ...
        sNameTF.setFont(new java.awt.Font("Georgia", 3, 14)); // NOI18N
        ...
        jTextField10.setText("Student id card");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(stdCB, 0, 172, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jLabel17)
                        .addGap(15, 15, 15)
                        .addComponent(sesCB, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(confB)
    ...
    private void stdCBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_stdCBActionPerformed
        ...
        try {
            ...
            String query3 = "SELECT sr,name FROM studentInfo WHERE class='"+std+"' and session='"+(String)sesCB.getSelectedItem()+"' ORDER BY NAME;";
...
yScale=Double.parseDouble(ySTF.getText());
    ...
    private void printMActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printMActionPerformed
        ...
        try {
            ...
            String query1 = "CREATE DATABASE IF NOT EXISTS rsl;";
            String query2 = "USE rsl;";
            String query3 = "SELECT name,fname,class,fcon,sr,dob,address FROM studentInfo WHERE class='"+std+"' and session='"+(String)sesCB.getSelectedItem()+"' ORDER BY name;";
            ...
            fcon=new String[selected.length];
            ...
            while(rs.next()){
                ...
                while(j<selected.length){
                    if(i==selected[j]){
                        ...
                        fcon[arrayPos]=rs.getString("fcon");
            ...
            if(sname.length %9 ==0){
                numberOfPages=sname.length/9;
            }
            else{
                numberOfPages=sname.length/9+1;
            }
...
s2L.setIcon(null);// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ICardCreate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ICardCreate().setVisible(true);
            }
        });
    }
