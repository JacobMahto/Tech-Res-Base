  ...
  //to fetch the basic details of selected students
    public static void jac() {
        ...
        try {
            ...
            String query3 = "SELECT name,fname,mname,class,medium,sr,dob,session FROM studentInfo WHERE class='" + reportCardE.stdCB.getSelectedItem() + "' AND session='"+reportCardE.sessionCB.getSelectedItem()+"';";
...
//JOptionPane.showMessageDialog(null, Arrays.toString(sname));
            con.close();
...
reportCardE.sessTF.setText("SESSION : "+(sess-1)+"-"+sess);
      }
...
reportCardE.stdTF.setText((String)reportCardE.stdCB.getSelectedItem());
try{
    ...
    stIm.setIcon(new ImageIcon("D:/"+sr[posn]+".jpg"));}
catch(Exception e){}
